...
<script>
    ...
    function getdata() {
        ...
        $.ajax({
            type: "post",
            url: "GetTheStudentAllRequest.action",
            datatype: "json",
            success: function (data) {
                var count=0
                var json = JSON.parse(data)
                ...
                $('#forhomepageinfo').append('<div class="col-md-4 stat-item" id="forbeg">'+count+'<span>待处理申请</span> </div>');
        ...
        $.ajax({
            type:"post",
            url:"GetTheStudentAnnouncement.action",
            datatype:"json",
            success:function (data1) {
                var json = JSON.parse(data1);
                $('#forhomepageinfo').append('<div class="col-md-4 stat-item" id="forbeg">'+json.length+'<span>本栋公告</span> </div>');
            },
            error:function () {
                alert("页面初始化失败")
            }
        ...
        $.ajax({
            ...
            success:function (data2) {
                ...
                $('#basicinfo').append('<li>'+"电话" +'<span>'+json["S_Phonenum"]+'</span></li>');
                $('#basicinfo').append('<li>'+"所属栋号" +'<span>'+json["S_Building"]+'</span></li>');
                $('#basicinfo').append('<li>'+"所属寝室" +'<span>'+json["S_Room"]+'</span></li>');
                $('#aboutinfo').append('<p>'+json["S_Information"]+'</p>')
            },
            error:function () {
                alert("页面初始化失败")
            }
